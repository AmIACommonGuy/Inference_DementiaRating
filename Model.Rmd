...
```{r}
fit0 <- vglm(data = df, 
             CDR_ord ~ EDUC_cat*(SEX+Marriage+ DEP + FEVALAGE + RES_PRIVATE),
             family = cumulative('logitlink', parallel = T))
summary(fit0)
```
